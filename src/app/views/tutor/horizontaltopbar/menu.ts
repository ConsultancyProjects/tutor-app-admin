...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            {
                id: 7,
                label: 'MENUITEMS.TUTORS.LIST.ALERTS',
                link: '/manageTutors/alerts',
                parentId: 6
            },
            {
                id: 8,
                label: 'MENUITEMS.TUTORS.LIST.BUTTONS',
                link: '/addTutor/buttons',
                parentId: 6
            },
            {
                id: 9,
                label: 'MENUITEMS.TUTORS.LIST.CARDS',
                link: '/ui/cards',
                parentId: 6
            },
            {
                id: 10,
                label: 'MENUITEMS.TUTORS.LIST.CAROUSEL',
                link: '/ui/carousel',
                parentId: 6
            },
