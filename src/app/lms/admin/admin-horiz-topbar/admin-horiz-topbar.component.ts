...
@Component({
  selector: 'app-admin-horiz-topbar',
  templateUrl: './admin-horiz-topbar.component.html',
  styleUrls: ['./admin-horiz-topbar.component.scss']
})

/**
 * Horizontal Topbar and navbar specified
 */
export class AdminHorizTopbarComponent implements OnInit, AfterViewInit {
