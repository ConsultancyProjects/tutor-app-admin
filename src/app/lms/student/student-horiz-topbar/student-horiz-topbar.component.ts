...
import { APIAuthenticationService } from 'src/app/core/services/authapi.service';
...
@Component({
  selector: 'app-student-horiz-topbar',
  templateUrl: './student-horiz-topbar.component.html',
  styleUrls: ['./student-horiz-topbar.component.scss']
})
export class StudentHorizTopbarComponent implements OnInit, AfterViewInit {
