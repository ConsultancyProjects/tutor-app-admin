...
export const MENU: MenuItem[] = [
    {
        id: 1,
        label: 'STUDENTMENU.HOME.TEXT',
        icon: 'bx-home-circle',
        subItems: [
            {
                id: 2,
                label: 'STUDENTMENU.HOME.LIST.EXPLORE',
                link: 'exploreCourses',
                parentId: 1
            },{
                id: 2,
                label: 'STUDENTMENU.HOME.LIST.MINE',
                link: 'myCourses',
                parentId: 1
            },{
                id: 2,
                label: 'STUDENTMENU.HOME.LIST.TODAY',
                link: 'todayClass',
                parentId: 1
            }
        ]
    ...
    {
        id: 6,
        label: 'STUDENTMENU.TUTORS.TEXT',
        icon: 'bx-tone',
        isUiElement: true,
        subItems: [
            {
                id: 7,
                label: 'STUDENTMENU.TUTORS.LIST.EXPLORE',
                link: 'exploreTutors',
                parentId: 6
            },
            {
                id: 8,
                label: 'STUDENTMENU.TUTORS.LIST.ASKAQUESTION',
                link: 'askQuestion',
                parentId: 6
            }
