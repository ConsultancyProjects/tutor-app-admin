...
export const MENU: MenuItem[] = [
    {
        id: 1,
        label: 'TUTORMENU.HOME.TEXT',
        icon: 'bx-home-circle',
        subItems: [
            {
                id: 2,
                label: 'TUTORMENU.HOME.LIST.EXPLORE',
                link: 'exploreCourses',
                parentId: 1
            },{
                id: 2,
                label: 'TUTORMENU.HOME.LIST.TODAY',
                link: 'todayClass',
                parentId: 1
            }
        ]
    ...
    {
        id: 6,
        label: 'TUTORMENU.TUTORS.TEXT',
        icon: 'bx-tone',
        isUiElement: true,
        subItems: [
            {
                id: 7,
                label: 'TUTORMENU.TUTORS.LIST.EXPLORE',
                link: 'exploreTutors',
                parentId: 6
            },
            {
                id: 8,
                label: 'TUTORMENU.TUTORS.LIST.ANSWERQUESTION',
                link: 'answerQuestion',
                parentId: 6
            }
    ...
    {
        id: 26,
        label: 'TUTORMENU.STUDENT.TEXT',
        icon: 'bx-customize',
        subItems: [
            {
                id: 28,
                label: 'TUTORMENU.STUDENT.LIST.ASSIGNCOURSE',
                link: 'assignCourse',
                parentId: 26
            },
            {
                id: 29,
                label: 'TUTORMENU.STUDENT.LIST.REMOVESTUDENTFROMCOURSE',
