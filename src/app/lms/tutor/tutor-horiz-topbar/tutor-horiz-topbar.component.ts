...
@Component({
  selector: 'app-tutor-horiz-topbar',
  templateUrl: './tutor-horiz-topbar.component.html',
  styleUrls: ['./tutor-horiz-topbar.component.scss']
})
export class TutorHorizTopbarComponent implements OnInit, AfterViewInit {
